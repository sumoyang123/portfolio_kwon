(function (k, d) {
    ...
    function y(a, b, c) {
      ...
      this.addEventListener("clickenter", this.onClickStart);
      this.addEventListener("clickleave", this.onClickEnd);
    ...
    y.prototype = Object.assign(Object.create(d.Sprite.prototype), {
        ...
        addHoverText: function (a, b) {
            b = void 0 === b ? 40 : b;
            this.element || (this.element = document.createElement("div"), this.element.style.display = "none", this.element.style.color = "#fff", 
